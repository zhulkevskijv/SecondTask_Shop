let _makeHtml = ({
    ...
    let $product = $(`<div class="description-toggle card bg-table card-col-xs-12 col-sm-4 col-md-4 col-lg-3 py-lg-3 py-sm-2" 
                                    data-product-id="${id}" >`);
    $product.append($(`<img src="${image_url}" alt="${name}" class="card-img bg-light product-image" data-toggle="modal" data-target="#myModal">`));
    ...
    $product.append($(`<button class="btn-success btn buy" data-product-id="${id}">`).text("Buy"));
